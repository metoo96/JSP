...
<html lang="">
	...
	<div style="width: 85%">
		<form class="form-horizontal">
			<div class="form-group">
		    	...
		    	<div class="col-sm-10">
		      		<input type="text" value="<%=news.getTitle() %>" id="title" class="form-control">
		    	</div>
		 	</div>
		 	<div class="form-group">
		    	<label for="author" class="col-sm-2 control-label">作者</label>
		    	<div class="col-sm-10">
		      		<input type="text" value="<%=news.getAuthor() %>" id="author" class="form-control">
		    	</div>
		 	</div>
		</form>
	</div>
	...
	<input id="activityID" value="<%=news.getId() %>" style="visibility: hidden" hidden>
	 ...
	 <script type="text/javascript" src="<%=basePath %>js/backgroundAdmin/NewsCenter/kindeditor/kindeditor-all.js"></script>
	  ...
	  <script>
	        ...
	        function getData(){
	        	...
	        	$.ajax({
	        		url:"/schoolmates/SchoolmateActivity/editPage",
	        		type:"POST",
	        		data:data,
