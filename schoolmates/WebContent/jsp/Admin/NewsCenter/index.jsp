...
<html lang="">
	...
	<body>
		...
		<div align="right" style="margin-bottom: 1em">
			<a href="<%=basePath%>jsp/Admin/NewsCenter/addNewsPage.jsp" type="button" class="btn btn-primary">发布新闻</a>
		</div>
        ...
        %>
		<ul class="list-group">
				<a  href="/schoolmates/NewsCenter/showNewsPage?newsID=<%=news.getNewsID()%>">
				  <li class="list-group-item listItems">
					  ...
					  <div class="col-xs-2 col-sm-2 col-md-2" align="right">
					  	<a type="button" href="/schoolmates/NewsCenter/editNews?newsID=<%=news.getNewsID() %>" class="btn btn-primary">修改</a>
		...
		<div align="center">
			<nav>
			  <ul class="pagination">
			      <% if (currentPage != 1) { %>
				    <li>
				      <a href="/schoolmates/NewsCenter/index?page=<%=previousPage%>" aria-label="Previous">
				        <span aria-hidden="true">上一页</span>
				      </a>
				    </li>
				    <%} %>
	
			         <li class="active"><a href="/schoolmates/NewsCenter/index?page=<%=currentPage%>"><%=currentPage%></a></li>
			 
				    <li>
				      <a href="/schoolmates/NewsCenter/index?page=<%=nextPage%>" aria-label="Next">
		...
		<script type="text/javascript">
			...
			function delNews(newsID){
				...
				if(confirm("您确定要删除该条信息吗？")){
					$.ajax({
						url:"/schoolmates/NewsCenter/delNews",
						data:data,
						type:"POST",
