...
<html lang="">
	...
	<body style="min-width: 100%" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width="100%">
        ...
        <div class="nav-navbar navbar" align="center">
			<span>
				<a href="/schoolmates/Home/SchoolmateOrganize/subPage?firstIndex=0" class="nav-btn">
					会长致辞
				</a>
			</span>
			<span>
				<a href="/schoolmates/Home/SchoolmateOrganize/subPage?firstIndex=3" class="nav-btn">
					组织章程
				</a>
			</span>
			<span>
				<a href="/schoolmates/Home/SchoolmateOrganize/subPage?firstIndex=4" class="nav-btn">
					学生校友工作协会
				</a>
			</span>
			<span>
				<a href="/schoolmates/Home/SchoolmateOrganize/subPage?firstIndex=1" class="nav-btn">
					地方校友分会
				</a>
			</span>
			<span>
				<a href="/schoolmates/Home/SchoolmateOrganize/subPage?firstIndex=2" class="nav-btn">
					院系校友分会
				</a>
			</span>
			...
			<!-- 
				...
				院系校友分会
			 -->
			<span id="position" style="position: absolute;right: 0;margin-top: 1px">
				当前位置:校友组织
			</span>
		</div> 
		<div id="index">
			...
			<iframe src="/schoolmates/Home/SchoolmateOrganize/subPage?firstIndex=0" width="100%" height="1100px" frameBorder="0" scrolling="yes"></iframe>
