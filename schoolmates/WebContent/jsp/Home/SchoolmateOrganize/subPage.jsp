		...
		<div class="news-content">
			...
			<ul id="news-list">
			     <% for (int i = 0; i < newslist.size(); i++) {
                    SchoolmateOrganize news = (SchoolmateOrganize)newslist.get(i);
                 %>
					<li>
						<a href="/schoolmates/Home/SchoolmateOrganize/showDetail?id=<%=news.getId() %>" >
							<div class="news">
								<div class="row">
									<div class="col-xs-11">
										<div class="title">
		...
		<div class="nav-footer">
			...
			<nav>
			  <ul class="pagination">
			      <% if (currentPage != 1) { %>
				    <li>
				      <a href="/schoolmates/Home/SchoolmateOrganize/subPage?page=<%=previousPage%>" aria-label="Previous">
				        <span aria-hidden="true">上一页</span>
				      </a>
				    </li>
				    <%} %>
	
			         <li class="active"><a href="/schoolmates/Home/SchoolmateOrganize/subPage?page=<%=currentPage%>"><%=currentPage%></a></li>
			 
				    <li>
				      <a href="/schoolmates/Home/SchoolmateOrganize/subPage?page=<%=nextPage%>" aria-label="Next">
