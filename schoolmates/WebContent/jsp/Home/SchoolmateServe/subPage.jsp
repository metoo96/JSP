	...
	<div class="content">
		...
		<div class="news-content">
			...
			<ul id="news-list">
                 ...
                 %>
					<li>
						<a href="/schoolmates/Home/SchoolmateServe/showDetail?id=<%=news.getId() %>" >
							<div class="news">
								<div class="row">
									<div class="col-xs-11">
										<div class="title">
		...
		<div class="nav-footer">
			...
			<nav>
			  <ul class="pagination">
			      <% if (currentPage != 1) { %>
				    <li>
				      <a href="/schoolmates/Home/SchoolmateServe/subPage?page=<%=previousPage%>" aria-label="Previous">
				        <span aria-hidden="true">上一页</span>
				      </a>
				    </li>
				    <%} %>
	
			         <li class="active"><a href="/schoolmates/Home/SchoolmateServe/subPage?page=<%=currentPage%>"><%=currentPage%></a></li>
			 
				    <li>
				      <a href="/schoolmates/Home/SchoolmateServe/subPage?page=<%=nextPage%>" aria-label="Next">
