		...
		<div class="nav-footer">
			...
			<nav>
			  <ul class="pagination">
			      <% if (currentPage != 1) { %>
				    <li>
				      <a href="/schoolmates/Home/SchoolmateActived/subPage?page=<%=previousPage%>" aria-label="Previous">
				        <span aria-hidden="true">上一页</span>
				      </a>
				    </li>
				    <%} %>
	
			         <li class="active"><a href="/schoolmates/Home/SchoolmateActived/subPage?page=<%=currentPage%>"><%=currentPage%></a></li>
			 
				    <li>
				      <a href="/schoolmates/Home/SchoolmateActived/subPage?page=<%=nextPage%>" aria-label="Next">
