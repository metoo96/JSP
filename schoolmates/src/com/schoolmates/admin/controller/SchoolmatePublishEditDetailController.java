...
/**
 * SchoolmatePublishEditDetailController
 * @author Guozhu Zhu
 * @date 2017/12/24
 * @version 1.0 
 *
 */
public class SchoolmatePublishEditDetailController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		news.setTitle(request.getParameter("title"));
		   try {
	            ...
	            String sql="update schoolmate_publish set title='"+news.getTitle()+"' where id="+request.getParameter("id");
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Admin/SchoolmatePublish/editDetail.jsp");
