...
/**
 * SchoolmateActivityDelNewsController
 * @author Guozhu Zhu
 * @date 2017/12/23
 * @version 1.0
 *
 */
public class SchoolmateActivityDelNewsController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		request.setCharacterEncoding("UTF-8");
		   try {
	            ...
	            String sql="delete from schoolmate_activity where id="+request.getParameter("id");
