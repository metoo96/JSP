...
/**
 * SchoolmateOrganizeShowIndexPage
 * @author Guozhu Zhu
 * @date 2017/12/23
 * @version 1.0
 *
 */
public class SchoolmateOrganizeShowIndexPageController extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		  try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Admin/SchoolmateOrganize/showIndexPage.jsp");
