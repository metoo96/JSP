...
/**
 * SchoolmateServerShowNewsPageController
 * @author Guozhu Zhu
 * @date 2017/12/23
 * @version 1.0
 *
 */
public class SchoolmateServerShowNewsPageController extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Admin/SchoolmateServer/showServerPage.jsp");
