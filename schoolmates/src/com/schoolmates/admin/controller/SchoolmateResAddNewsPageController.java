...
/**
 * SchoolmateResAddNewsPageController
 * @author Guozhu Zhu
 * @date 2017/12/23
 * @version 1.0
 *
 */
public class SchoolmateResAddNewsPageController extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		System.out.println(htmlData);
		   try {
	            ...
	            String sql="insert into news_schoolmate(title,content,form,date)values('"+news.getTitle()+"','"+news.getContent()+"','"+news.getForm()+"','"+news.getDate()+"')";
