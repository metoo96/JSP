...
/**
 * NewsCenterEditNewsController(后台新闻编辑)
 * @author Guozhu Zhu
 * @date 2017/12/21
 * @version 1.0
 *
 */
public class NewsCenterEditNewsController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		System.out.println(htmlData);
		   try {
	            ...
	            String sql="update news set title='"+news.getTitle()+"',content='"+news.getContent()+"',form='"+news.getForm()+"',date='"+news.getDate()+"' where newsID ="+news.getNewsID();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Admin/NewsCenter/editNews.jsp");
