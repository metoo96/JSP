...
/**
 * NewsCenterIndexController(显示后台新闻列表)
 * @author Guozhu Zhu
 * @date 2017/12/21
 * @version 1.0
 *
 */
public class NewsCenterIndexController extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Admin/NewsCenter/index.jsp");
