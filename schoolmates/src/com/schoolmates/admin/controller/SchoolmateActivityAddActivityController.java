...
/**
 * SchoolmateActivityAddActivityController
 * @author Guozhu Zhu
 * @date 2017/12/23
 * @version 1.0
 *
 */
public class SchoolmateActivityAddActivityController extends HttpServlet{
	    ...
	    public SchoolmateActivity news = null;
		...
		public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
			...
			System.out.println(htmlData);
			   try {
		            ...
		            String sql="insert into schoolmate_activity(title,content,author,date)values('"+news.getTitle()+"','"+news.getContent()+"','"+news.getAuthor()+"','"+news.getDate()+"')";
