...
/**
 * SchoolmateResDelNewsController
 * @author Guozhu Zhu
 * @date 2017/12/23
 * @version 1.0
 *
 */
public class SchoolmateResDelNewsController extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		request.setCharacterEncoding("UTF-8");
		   try {
	            ...
	            String sql="delete from news_schoolmate where newsID="+request.getParameter("newsID");
