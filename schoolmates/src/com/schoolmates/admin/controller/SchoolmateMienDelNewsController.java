...
/**
 * SchoolmateMienDelNewsController
 * @author Guozhu Zhu
 * @date 2017/12/24
 * @version 1.0
 *
 */
public class SchoolmateMienDelNewsController extends HttpServlet{
		...
		public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
			...
			request.setCharacterEncoding("UTF-8");
			   try {
		            ...
		            String sql="delete from mien where id="+request.getParameter("id");
