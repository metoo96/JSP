...
/**
 * NewsCenterShowNewsPageController(显示后台新闻的详情）
 * @author Guozhu Zhu
 * @date 2017/12/21
 * @version 1.0
 *
 */
public class NewsCenterShowNewsPageController extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Admin/NewsCenter/showNewsPage.jsp");
