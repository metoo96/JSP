...
/**
 * SchoolmatePublishAddPublishController
 * @author Guozhu Zhu
 * @date 2017/12/24
 * @version 1.0
 *
 */
public class SchoolmatePublishAddPublishController extends HttpServlet{
		...
		public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
			...
			news.setTitle(request.getParameter("title"));
			   try {
		            ...
		            String sql="insert into schoolmate_publish(title, head_image, download_url)values('"+news.getTitle()+"','default','default')";
