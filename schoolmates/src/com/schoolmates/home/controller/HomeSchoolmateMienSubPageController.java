...
/**
 * HomeSchoolmateMienSubPageController
 * @author Guozhu Zhu
 * @date 2017/12/24
 * @version 1.0
 *
 */
public class HomeSchoolmateMienSubPageController extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql="select*from mien limit "+start+", 10";
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/Home/SchoolmateMien/subPage.jsp");
